...
public partial class @BuilderCamera : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""DoAction"",
                    ""type"": ""Button"",
                    ""id"": ""2c1ba3ea-02d7-4ba1-9734-02d19df17bea"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""UndoAction"",
                    ""type"": ""Button"",
                    ""id"": ""ff390a6d-0a28-4e3e-8220-82e410c1dec2"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""099fb76d-5b36-40de-a7d1-a3450afa6888"",
                ...
                {
                    ""name"": """",
                    ""id"": ""bc592e72-1cb8-42f8-b581-2519f27c4f23"",
    ...
    ""controlSchemes"": [
        ...
        m_Camera_DoAction = m_Camera.FindAction("DoAction", throwIfNotFound: true);
        m_Camera_UndoAction = m_Camera.FindAction("UndoAction", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Camera_DoAction;
    private readonly InputAction m_Camera_UndoAction;
    public struct CameraActions
    {
        ...
        public InputAction @DoAction => m_Wrapper.m_Camera_DoAction;
        public InputAction @UndoAction => m_Wrapper.m_Camera_UndoAction;
        ...
        public void SetCallbacks(ICameraActions instance)
        {
            if (m_Wrapper.m_CameraActionsCallbackInterface != null)
            {
                ...
                @DoAction.started -= m_Wrapper.m_CameraActionsCallbackInterface.OnDoAction;
                @DoAction.performed -= m_Wrapper.m_CameraActionsCallbackInterface.OnDoAction;
                @DoAction.canceled -= m_Wrapper.m_CameraActionsCallbackInterface.OnDoAction;
                @UndoAction.started -= m_Wrapper.m_CameraActionsCallbackInterface.OnUndoAction;
                @UndoAction.performed -= m_Wrapper.m_CameraActionsCallbackInterface.OnUndoAction;
                @UndoAction.canceled -= m_Wrapper.m_CameraActionsCallbackInterface.OnUndoAction;
            }
